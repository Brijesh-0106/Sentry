      ...
      <div className="leftSignInPart h-full w-1/2 flex justify-center items-center">
        <div className="flex  w-96.25  flex-col items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl h-20 text-[#cc7bf4] font-bold">
              {/* Line 1 */}
              <span>{line1}</span>
          ...
          <div className="not-odd mt-4 px-4 py-8 border w-full flex flex-col rounded-4xl justify-center items-center border-zinc-700 dummyButton">
            <button
              className="bg-[#faf9f5] cursor-pointer w-80 text-center justify-center flex py-2 px-3 gap-1 text-lg items-center rounded-lg"
              onClick={() => {
                signIn();
              }}
            >
            ...
            <div>
              <input
                type="text"
                className="text bg-zinc-900 mb-4 border border-zinc-500 placeholder-gray-300::placeholder text-zinc-100 text-lg px-4 py-3 w-80 rounded-lg"
                placeholder="Enter your email"
              />
              <button className="bg-[#faf9f5]  w-80 text-center justify-center cursor-pointer flex py-2 px-3 gap-1 text-lg items-center rounded-lg">
                Continue with Email
              </button>
            </div>
          </div>
